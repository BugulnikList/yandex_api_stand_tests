...
URL_SERVICE = "https://ba7db251-277e-4626-b780-7a51961bd60b.serverhub.praktikum-services.ru"
...
# добавили переменную, содержащую путь до логов
LOG_MAIN_PATH = "/api/logs/main/"

# добавили переменную, содержащую путь до таблицы
